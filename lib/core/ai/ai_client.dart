...
abstract class AIClient {
  ...
  Future<Map<String, dynamic>> analyzeInvestmentPortfolio(Map<String, dynamic> portfolio);
  Future<String> generateBudgetPlan(Map<String, dynamic> financialData);
  Future<Map<String, dynamic>> detectAnomalies(List<Map<String, dynamic>> transactions);
}
...
class AIClientImpl implements AIClient {
  ...
  List<Map<String, dynamic>> _buildMessages(String prompt, Map<String, dynamic>? context) {
  ...
  @override
  Future<Map<String, dynamic>> analyzeFinancialData(Map<String, dynamic> data) async {
    try {
      final prompt = '''
  ...
  @override
  Future<Map<String, dynamic>> getFinancialInsights(Map<String, dynamic> data) async {
    try {
      final prompt = '''
  ...
  @override
  Future<Map<String, dynamic>> analyzeInvestmentPortfolio(Map<String, dynamic> portfolio) async {
    try {
      final prompt = '''
  ...
  @override
  Future<Map<String, dynamic>> detectAnomalies(List<Map<String, dynamic>> transactions) async {
    try {
      final prompt = '''
    ...
    for (final section in sections) {
      if (section.trim().isNotEmpty) {
        ...
        if (lines.isNotEmpty) {
          ...
          final content = lines.skip(1).where((line) => line.trim().isNotEmpty).join('\n');
